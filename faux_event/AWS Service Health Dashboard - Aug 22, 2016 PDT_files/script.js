...
var realm;
var notListedMessage;

var noOfDaysInWeek = 7;
var noOfWeeksToShowInHistory = 53; // Showing history for 53 weeks (For the business requirement of 365 (or more) days)
...
var noOfDaysShownInHistory = noOfWeeksToShowInHistory*noOfDaysInWeek;
...
function showDate(locale, date, left) {
    ...
    for (var i=0;i<rows;i++) {
        ...
        for (var j=0;j<cols;j++) {
            ...
            if (servicesLaunch[locale][i] > stamp) { /* We don't have any info before the service launch date. */
                var c = document.createElement('td');
                c.innerHTML = '<img src="/images/status-disabled.gif" title="' + notListedMessage + '" />';
                r.appendChild(c);
